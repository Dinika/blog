...
### Scene study from Kiki's Delivery Service

![Scene study from Kiki's Delivery Service](./3_22_03_2025_Scene_Study_kiki_delivery_service.jpg)

#### Things I did well

- The colors. I really like the biege apperance of the frock.
- The facial expression. I like that Kiki is slightly smiling.

#### Things I did not do well

- The composition of the wheat-y flower on the left - I wish it was higher.
- The shadow on Kiki's dress does not have a corresponding object in the foreground scene (ie unclear what's casting that shadow). 

#### One concrete thing I can improve in the next study

- Pay attention to shadows on the character and see if the object can/should be included in the scene.
